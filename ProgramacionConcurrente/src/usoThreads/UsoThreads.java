...
class MarcoRebote extends JFrame{
	...
	//detenemos los hilos (pelotas) que están ejecutandose 
    public void detener(ActionEvent e){
		if(e.getSource().equals(detener1)){ //obtenemos la fuente la cual ha generado el evento
			t1.interrupt(); //segun la fuenta que haya generado el evento detenemos ese hilo
